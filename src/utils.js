...
export const mnemonicToEntropyLength = (mnemonic) => {
...
export const bitwiseXorHexString = (hexStrings) => {
...
export const sha256Double = (data) => {
    return sha256(sha256(data));
};
export const getRandomEntropy = async (length = 32) => {
...
export const getDeterministicEntropyFromMnemonic = async (salt, mnemonic, part, nofParts, entropyLength) => {
